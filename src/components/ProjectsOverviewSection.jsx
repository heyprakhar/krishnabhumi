...
const ProjectsOverviewSection = () => {
  return (
    <section
      id="projects"
      className="relative bg-[#f9f8f7] py-12 sm:py-14 md:py-20"
    >
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10 sm:gap-12 px-4 sm:px-6 lg:px-8">
        {/* Left: Text content */}
        <div className="w-full md:w-1/2">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold uppercase text-[#2d2f32] mb-2 font-dm-serif">
            Projects Overview
          </h2>
          <h3 className="uppercase text-[#a18c5d] text-sm sm:text-base font-semibold mb-4 tracking-wider font-inter">
            See why our residents call our community home.
          </h3>
          <p className="mb-4 text-sm sm:text-base text-[#939698] font-inter">
          ...
          <p className="mb-6 text-sm sm:text-base text-[#939698] font-inter">
          ...
          <a
            href="#about"
            className="inline-block bg-[#8e6136] hover:bg-[#a18c5d] border-2 border-[#8e6136] hover:border-[#a18c5d] text-white font-medium py-2 px-6 sm:px-7 rounded shadow text-sm sm:text-base uppercase tracking-wide transition-colors font-inter"
          >
            About Us
          </a>
        </div>
        ...
        <div className="w-full md:w-1/2 flex justify-center items-center">
          <img
            ...
            className="rounded-xl shadow-lg border w-full max-w-xs sm:max-w-sm md:max-w-full h-auto object-cover"
          />
        </div>
      </div>
    </section>
